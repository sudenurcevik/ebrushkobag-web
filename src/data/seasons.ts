...
export const SEASONS: Season[] = [
  {
    ...
    video: {
      src: '/videos/seasons/spring.mp4',
      alt: 'Bahar koleksiyonundan kısa görüntüler',
      width: 1920,
      height: 1080,
      required: true,
    },
...

  {
    ...
    video: {
      src: '/videos/seasons/summer.mp4',
      alt: 'Yaz koleksiyonundan kısa görüntüler',
      width: 1920,
      height: 1080,
      required: true,
    },
...

  {
    ...
    video: {
      src: '/videos/seasons/autumn.mp4',
      alt: 'Sonbahar koleksiyonundan kısa görüntüler',
      width: 1920,
      height: 1080,
      required: true,
    },
...

  {
    ...
    video: {
      src: '/videos/seasons/winter.mp4',
      alt: 'Kış koleksiyonundan kısa görüntüler',
      width: 1920,
      height: 1080,
      required: true,
    },
